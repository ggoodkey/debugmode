declare namespace APP {
     ...
     */
    function setDebugMode(debugMode: boolean): boolean;
    /** toggles debugging to the console on or off
     * @param { boolean } debugMode true = on, false = off
     * @returns { boolean } the set value of DEBUG_TO_CONSOLE
     */
    function setDebugToConsole(debugMode: boolean): boolean;
     ...
     * @returns { void }
     */
    function cacheMsg(code: any, description?: string, severity?: boolean): void;
     ...
     * @returns { void }
     */
    function debug(code: any, description?: string, severity?: boolean): void;
}
